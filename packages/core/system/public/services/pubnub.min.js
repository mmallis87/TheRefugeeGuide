...
(function() {
    ...
    */
            ...
            switch (typeof e) {
                ...
                case "object":
                    ...
                    if (m && "object" === typeof m) {
                        ...
                        for (r in e) Object.hasOwnProperty.call(e, r) && (g = b(r, e)) && h.push(d(r) + (f ? ": " : ":") + g);
                    g = 0 === h.length ? "{}" : f ? "{\n" + f + h.join(",\n" + f) + "\n" +
                        l + "}" : "{" + h.join(",") + "}";
                    f = l;
                    return g
    ...
    function N(a, d) {
        if (a && d)
            if (a && (Array.isArray && Array.isArray(a) || "number" === typeof a.length))
    ...
    function ya(a, d) {
        ...
        if (d) {
            ...
            for (f = 0; 16 > f; f++) b += String.fromCharCode(a[f]);
        return b
    }
    ...
    function Oa(a) {
        var d = [],
            b;
        if (xa)
            for (b = 0; 4 > b; b++) d[4 * b] = Ta[a[4 * b]] ^ Ua[a[1 + 4 * b]] ^ Za[a[2 + 4 * b]] ^ $a[a[3 + 4 * b]], d[1 + 4 * b] = $a[a[4 * b]] ^ Ta[a[1 + 4 * b]] ^ Ua[a[2 + 4 * b]] ^ Za[a[3 + 4 * b]], d[2 + 4 * b] = Za[a[4 * b]] ^ $a[a[1 + 4 * b]] ^ Ta[a[2 + 4 * b]] ^ Ua[a[3 + 4 * b]], d[3 + 4 * b] = Ua[a[4 * b]] ^ Za[a[1 + 4 * b]] ^ $a[a[2 + 4 * b]] ^ Ta[a[3 + 4 * b]];
        else
            for (b = 0; 4 > b; b++) d[4 * b] = ab[a[4 * b]] ^ bb[a[1 + 4 * b]] ^ a[2 + 4 * b] ^ a[3 + 4 * b], d[1 + 4 * b] = a[4 * b] ^ ab[a[1 + 4 * b]] ^ bb[a[2 + 4 * b]] ^ a[3 + 4 * b], d[2 + 4 * b] = a[4 * b] ^ a[1 + 4 * b] ^ ab[a[2 + 4 * b]] ^ bb[a[3 + 4 * b]], d[3 + 4 * b] = bb[a[4 * b]] ^ a[1 + 4 * b] ^ a[2 + 4 * b] ^ ab[a[3 + 4 *
                b]];
        return d
    }
    ...
    O = {
        ...
        Hash: {
            MD5: function(a) {
                ...
                var m = [],
                    u, x, t, r, g, j, h, l, e = eb("",
                        8),
                    m = a.length;
                u = m + 8;
                x = 16 * ((u - u % 64) / 64 + 1);
                    ...
                    I = {
                        ...
                        unsubscribe: function(a, b) {
                            ...
                            N(c.split(","), function(a) {
                                var c = y;
                                a && (fa && (c = I.LEAVE(a, 0, b, e)), c || b({
                                    action: "leave"
                                }), B[a] = 0, a in Z && delete Z[a])
                            });
                            d()
                        },
                        ...
                        state: function(a, b) {
                            ...
                            f = f ? [K, "v2", "presence", "sub-key", w, "channel", encodeURIComponent(h),
                                "uuid", g, "data"
                            ] : [K, "v2", "presence", "sub-key", w, "channel", encodeURIComponent(h), "uuid", encodeURIComponent(g)];
                            E({
                                a: e,
                                data: l(d),
                                c: function(a) {
